...
output=${az_folder}/
seq 19 2 31 | parallel -j16 "velveth ${output}{} {} -longPaired -fastq -separate ${Data1} ${Data2}"
output=${az_folder}/
seq 19 2 31 | parallel -j16 "velvetg ${output}{}"
seq 19 2 31 | parallel python3 assignment4.py {} >> output/kmer_result.csv
